        ...
        */
        ...
        if (node.voices) {
            ...
            node.keyOn = (channel, pitch, velocity) => {
                ...
                node.fKeyLabel$.forEach(($: number) => node.factory.setParamValue(node.dspVoices$[voice], $, pitch));
                ...
                node.fVelLabel$.forEach(($: number) => node.factory.setParamValue(node.dspVoices$[voice], $, velocity));
